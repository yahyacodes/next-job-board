  ...
  return (
    <>
      <div className="sticky top-0 z-50 flex items-center justify-between">
        <NavigationMenu className="lg:w-[60rem] md:w-[40rem] w-[24rem] mx-auto md:border mt-4 border-neutral-300 dark:border-zinc-500 rounded-md p-2 relative bg-background ">
          <NavigationMenuList className="md:w-full md:flex md:items-center md:justify-between">
            ...
            <div
              className={`${
                isOpen ? "block" : "hidden"
              } md:block absolute md:relative top-full md:mt-0 md:left-0 mt-40 left-10 right-0`}
            >
              <ModeToggle />
            </div>
          </NavigationMenuList>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-background h-full z-40 md:hidden p-4">
